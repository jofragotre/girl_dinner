...
export default function HomeClient({ allRecipes, allCocktails, subtitles }: HomeClientProps) {
  ...
  }, [isShuffling, moods, fireConfetti, playDing, allRecipes, allCocktails, subtitles]);
